...
public enum ECountryCode {
    ...
    ECountryCode(final String name, final String alpha3) {
        this.name = name;
        this.alpha3 = alpha3;
    }

    public static boolean isValidCountryCode(String twoLetterCountryCode, String threeLetterCountryCode) {
        for (ECountryCode country : values()) {
            if (country.toString().equals(twoLetterCountryCode)) {
                if (country.alpha3.equals(threeLetterCountryCode)) {
                    return true;
                }
            }
        }
